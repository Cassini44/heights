...
/// <reference path="c:/Users/nyden/Home/Dev/JS/Heights Driving School Inc/Heights/shared/js/fcns.js" />
...
async function getDataForCreateAccount() {
    var response = await SERVER.POST('/public/account-creation-dropdowns')
...
window.onload = (async () => {
    ...
    var data = await getDataForCreateAccount()

    var courses_offered = j.pc(data.COURSES,'COURSE_NAME',true,false)
    ...
    const dropdowns = [
        { id: 'class_dropdown', options: courses_offered },
